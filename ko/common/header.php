    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../ko/service.php">SERVICES</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                        ...
                        <a class="dropdown-item" href="../ko/notice_list.php?wp_hp_field=05">NOTICE</a>
                        <a class="dropdown-item" href="../ko/review_list.php?wp_hp_field=01">REVIEW</a>
                        <a class="dropdown-item" href="../ko/gallery.php">GALLERY</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                        <a class="dropdown-item" href="../ko/qna.php">Q&A</a>
                        <a class="dropdown-item" href="../ko/contact.php">CONTACT</a>
                    </div>
                </li>
                <!--                <li class="nav-item">-->
