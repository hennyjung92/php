...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active py-5 bg-image-full" style="background-image: url('../img/boyanddog2.jpg');height: 250px; opacity:0.8 !important;">
            ...
            <div class="carousel-item py-5 bg-image-full" style="background-image: url('../img/boyanddog2.jpg');height: 250px; opacity:0.8 !important;">
                <div class="carousel-caption d-none d-md-block">
                    <!-- <h3>Second Slide</h3>
