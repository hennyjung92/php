        ...
        while($data = mysql_fetch_array($result)){
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <img class="img-fluid rounded mb-3 mb-md-0" src='./data/<?=$data[file01]?>' alt="" style="width: auto; height: auto; max-width: 700px; max-height: 300px; display: block; margin-left: auto; margin-right: auto;">
