...
<!--                <p class="ns" style="font-size:15px; padding-top: 30px;">실시간 분실 방지 및 통계</p>-->
                <p class="ns" style="font-size:15px; padding-top: 30px;">Real-time loss prevention and statistics</p>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
...
<!--                <p class="ns" style="font-size:15px; padding-top: 30px;">실시간 나의 위치 및<br>재난 대피 경로 파악</p>-->
                <p class="ns" style="font-size:15px; padding-top: 30px;">Identify my real-time location and disaster evacuation routes</p>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
